...
import { View, Text, Image, StyleSheet, TextInput, ScrollView, Button, TouchableOpacity, Dimensions, ImageBackground, Modal } from "react-native";
      ...
      <View style={styles.pdfstyle}>
        <View style={{ flexDirection: "row", justifyContent: "space-between", backgroundColor: "white" }}>
          <Ionicons
            ...
            size={24}
            color="black"
            style={{ marginTop: 30, marginHorizontal: 5, marginVertical: 20 }}
            onPress={() => {
              navigation.goBack();
            }}
          />
          <Text style={{ fontSize: 18, fontWeight: "500", marginTop: 30, color: "black", marginVertical: 20 }}>{data.title}</Text>
            ...
            <Modal visible={modalVisible} animationType="fade" transparent={true} onRequestClose={() => setModalVisible(false)}>
              <View style={{ justifyContent: "flex-end", width: 100, margin: 5, marginTop: 55, alignSelf: "flex-end" }}>
                <View style={{ backgroundColor: "#F0F0F0", padding: 15, opacity: 0.95 }}>
                  <TouchableOpacity
                    onPress={() =>
                      navigation.navigate("screenreader", {
                        pdfUrl: data.pdfUrl
                          ? data.pdfUrl
                          : "http://res.cloudinary.com/dfyvyvvvy/raw/upload/v1685432853/books/Harry_Potter_and_the_Half_Blood_Prince.pdf",
                      })
                    }
                  >
                    <View style={{ flexDirection: "row", justifyContent: "space-between", marginTop: 2 }}>
                      <FontAwesome5 name="headphones-alt" size={20} color="black" style={{ marginHorizontal: 2 }} />
                      <Text style={{ fontWeight: "800", marginLeft: 4 }}>Listen</Text>
                    </View>
                  </TouchableOpacity>
                  ...
                  <TouchableOpacity onPress={() => setModalVisible(false)}>
                    <View style={{ flexDirection: "row", justifyContent: "space-between", marginTop: 8 }}>
                      <FontAwesome name="close" size={20} color="black" style={{ marginHorizontal: 2 }} />
                      <Text style={{ fontWeight: "800", marginLeft: 8 }}>Close</Text>
                    </View>
                  </TouchableOpacity>
                </View>
              </View>
