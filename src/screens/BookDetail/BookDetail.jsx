      ...
      <ScrollView  style={{zIndex:-1}}>
        ...
        <View  style={{
          ...
          <View style={{flex:1,alignItems:'center',color:'white'}}>
            <Text style={{color:'white'}}>{bookDetails.average_rating}</Text>
          ...
          {/* ratngs count */}
          <View style={{flex:1,alignItems:'center',color:'white'}}>
            <Text style={{color:'white'}}>{bookDetails.ratings_count}</Text>
        ...
        <View >
          <ScrollView style={{borderColor:"#554994",marginHorizontal:20,marginVertical:10}} horizontal={false} >
            <ReadMore ReadMore
              numberOfLines={7}
        ...
        <View style={styles.review}>
          ...
          <View>
              ...
              <Text onPress={() => navigation.navigate("ReviewList")}  style={{marginRight:10,alignSelf:'flex-end',marginHorizontal:12,marginVertical:10,fontWeight:'600',paddingHorizontal:10,color:'grey'}}>View More</Text>
           </View>
           </ScrollView>
        </View>
          ...
          <Button title="Send" width="200" style={styles.button} color="#554994"/>
          </View>
        ...
        <View style={{height:70,marginTop:10,marginBottom:30,zIndex:1,marginHorizontal:10}}>
           {renderBottomButton()}
        </View>
      </View>
   );
